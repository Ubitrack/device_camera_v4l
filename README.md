device_camera_v4l
==============
This is the Ubitrack device_camera_v4l submodule.

Description
----------
The device_camera_v4l contains components for v4l capturing on linux.
...
If you handle multiple dependencies in your project is better to add a *conanfile.txt*
    ...
    [requires]
    ubitrack_device_camera_v4l/1.3.0@ubitrack/stable
...
## Upload
    ...
    $ conan upload -r ubitrack ubitrack_device_camera_v4l/1.3.0@ubitrack/stable
